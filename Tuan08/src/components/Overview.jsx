...
export default function Overview() {
  ...
  return (
    <div className="p-4">
      <div className="flex gap-2 font-bold text-lg my-2">
        <img src={dasborad} /> Overview
      </div>
      <div className="grid grid-flow-col gap-5 mt-3">
        <OverviewItem
          ...
          icon={cart}
          poc={turnover.poc}
          metric={formatUSD(turnover.metric)}
          bgColor="bg-[rgb(255,240,245)]"
        />
        <OverviewItem
          title="Profit"
          icon={money}
          poc={profit.poc}
          metric={formatUSD(profit.metric)}
          bgColor="bg-[rgb(240,246,255)]"
        />
        <OverviewItem
          title="New customer"
          icon={userIcon}
          poc={newCust.poc}
          metric={newCust.metric}
          bgColor="bg-[rgb(240,247,252)]"
        />
      </div>
    </div>
  );
